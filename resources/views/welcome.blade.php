  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg" style="border-radius: 1.5rem; overflow: hidden;">
      <div class="p-4 text-center position-relative">
        ...
        <h4 id="modalOrdenPagoLabel" class="fw-bold text-dark mb-2">
          Orden de Pago
        </h4>
        <p class="small text-muted mb-4">
          Gestione las órdenes de pago según su perfil.
        </p>

        <div class="d-flex flex-column text-start">
              <a href="{{ $configuraciones['url_orden_pago_empleadores'] ?? '#' }}" class="btn btn-outline-danger border-0 border-bottom text-start py-3 fw-bold rounded-0" target="_blank"><i class="fas fa-user-tie me-2"></i> Empleadores / Asegurados / Pensionados</a>
              <a href="{{ $configuraciones['url_orden_pago_ivss'] ?? '#' }}" class="btn btn-outline-danger border-0 text-start py-3 fw-bold rounded-0" target="_blank"><i class="fas fa-landmark me-2"></i> I.V.S.S</a>
        </div>
      </div>
    </div>
  </div>
              ...
              <div class="grid-services">
                  ...
                  <div class="service-tile" data-aos="fade-right" data-aos-delay="100">
                      ...
                      <div>
                          ...
                          <a href="{{ $configuraciones['url_marco_normativo'] ?? '#' }}" class="text-muted small text-decoration-none fw-bold" target="_blank">Leer más <i class="fas fa-chevron-right ms-1"></i></a>
                      </div>
                  </div>
                  ...
                  <div class="service-tile" data-aos="fade-right" data-aos-delay="200">
                      ...
                      <div>
                          ...
                          <a href="{{ $configuraciones['url_biblioteca_formas'] ?? '#' }}" class="text-muted small text-decoration-none fw-bold" target="_blank">Leer más <i class="fas fa-chevron-right ms-1"></i></a>
                      </div>
                  </div>
                  ...
                  <div class="service-tile" data-aos="fade-right" data-aos-delay="300">
                      ...
                      <div>
                          ...
                          <a href="{{ $configuraciones['url_contrataciones_publicas'] ?? '#' }}" class="text-muted small text-decoration-none fw-bold" target="_blank">Leer más <i class="fas fa-chevron-right ms-1"></i></a>
                      </div>
                  </div>
                  <!-- Farmapatria -->
                  <div class="service-tile" data-aos="fade-right" data-aos-delay="400">
                      ...
                      <div>
                          <h6 class="fw-bold mb-1">Farmapatria</h6>
                          <a href="{{ $configuraciones['url_farmapatria'] ?? '#' }}" class="text-muted small text-decoration-none fw-bold" target="_blank">Leer más <i class="fas fa-chevron-right ms-1"></i></a>
                      </div>
                  </div>
                  <!-- Boletín Informativo -->
                  <div class="service-tile" data-aos="fade-right" data-aos-delay="500">
                      ...
                      <div>
                          ...
                          <a href="{{ $configuraciones['url_boletin_informativo'] ?? '#' }}" class="text-muted small text-decoration-none fw-bold" target="_blank">Leer más <i class="fas fa-chevron-right ms-1"></i></a>
                      </div>
                  </div>
                  <!-- Revista -->
                  <div class="service-tile" data-aos="fade-right" data-aos-delay="600">
                      ...
                      <div>
                          ...
                          <a href="{{ $configuraciones['url_revista'] ?? '#' }}" class="text-muted small text-decoration-none fw-bold" target="_blank">Leer más <i class="fas fa-chevron-right ms-1"></i></a>
                      </div>
                  </div>
                  <!-- Verificaciones -->
