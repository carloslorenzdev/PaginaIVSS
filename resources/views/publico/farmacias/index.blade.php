            ...
            <div class="col-lg-3 col-md-4 col-sm-6 estado-item">
                <div class="card h-100 border-0 shadow-sm rounded-4 hover-elevate transition-all overflow-hidden">
                    <div class="card-body text-center p-4">
                        ...
                        <button class="btn btn-outline-primary rounded-pill w-100 fw-bold btn-ver-farmacia" data-estado="{{ $estado }}" data-bs-toggle="modal" data-bs-target="#modalFarmaciaInfo">
                            Ver Farmacias
                        </button>
                    </div>
                </div>
