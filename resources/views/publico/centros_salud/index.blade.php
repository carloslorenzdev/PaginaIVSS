...
@section('titulo', 'Centros de Salud - IVSS')
...
<div class="position-relative overflow-hidden text-center bg-light" style="padding: 100px 0 60px 0;">
    ...
    <div class="position-absolute top-0 start-0 w-100 h-100" style="background-image: url('{{ asset('img/medical-aesthetic-2.png') }}'); background-size: cover; background-position: center; opacity: 0.2; z-index: 0;"></div>
    ...
    <div class="container position-relative" style="z-index: 2;">
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="fade-up">
                ...
                <h1 class="display-4 fw-bold text-white mb-3">Centros de Salud IVSS</h1>
                <p class="lead text-white-50 mb-0">Seleccione en la siguiente lista para obtener información sobre los Hospitales y Ambulatorios del IVSS ubicados en su región.</p>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 estado-item">
                <div class="card h-100 border-0 shadow-sm rounded-4 hover-elevate transition-all overflow-hidden">
                    <div class="card-body text-center p-4">
                        ...
                        <button class="btn btn-outline-primary rounded-pill w-100 fw-bold btn-ver-centro" data-estado="{{ $estado }}">
                            Ver Centros
                        </button>
                    </div>
                </div>
...
<!-- Modal de Centros Info -->
<div class="modal fade" id="modalCentroInfo" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 1.5rem; overflow: hidden;">
            <div class="p-4 text-center position-relative">
                ...
                <h4 class="fw-bold text-dark mb-2">
                    Centros de Salud - <span id="modalEstadoNombre"></span>
                </h4>
                <p class="small text-muted mb-4">
                    Listado de Hospitales y Ambulatorios disponibles en este estado.
                </p>

                <div id="centrosListContainer" class="text-start mb-4">
...
<script nonce="{{ app('csp-nonce') ?? '' }}">
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const botones = document.querySelectorAll('.btn-ver-centro');
        let modal;
        try {
            modal = new bootstrap.Modal(document.getElementById('modalCentroInfo'));
        } catch (e) {
        ...
        botones.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if (centrosData[estado] && centrosData[estado].length > 0) {
                    const accordionHtml = document.createElement('div');
                    
                    centrosData[estado].forEach((centro, index) => {
                        const itemHtml = `
                        <div class="border rounded-3 mb-3 shadow-sm bg-white overflow-hidden">
                            <div class="p-3 bg-light text-primary d-flex justify-content-between align-items-center custom-accordion-header" style="cursor: pointer;">
                                <span class="fw-bold"><i class="fas fa-hospital me-2"></i> ${centro.nombre}</span>
                            ...
                            <div class="custom-accordion-body" style="background-color: #fff;">
                                <div class="d-flex align-items-start mb-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-secondary">${centro.direccion}</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-secondary">${centro.telefono}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        const centrosContainer = document.getElementById('centrosListContainer');
        if (centrosContainer) {
