...
@section('titulo', 'Beneficio Médico Integral - IVSS')
    ...
    <div class="container position-relative" style="z-index: 2;">
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="fade-up">
                ...
                <h1 class="display-4 fw-bold text-white mb-3">Beneficio Médico Integral</h1>
                <p class="lead text-white-50 mb-0">Atención médica, quirúrgica y farmacéutica garantizada para nuestros asegurados</p>
            </div>
        </div>
    </div>
