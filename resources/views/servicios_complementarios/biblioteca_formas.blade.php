...
@section('titulo', 'Biblioteca de Formas - IVSS')
    ...
    <div class="container position-relative" style="z-index: 2;">
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="fade-up">
                ...
                <h1 class="display-4 fw-bold text-white mb-3">Biblioteca de Formas</h1>
                <p class="lead text-white-50 mb-0">Planillas, formularios e instructivos para trámites del IVSS</p>
            </div>
        </div>
    </div>
