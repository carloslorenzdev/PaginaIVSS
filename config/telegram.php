...
return [
    ...
    */
    'bots' => [
        'mybot' => [
            'token' => env('OTP_TELEGRAM2FA_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
    ...
    */
     ...
     */
    'enabled' => env('OTP_TELEGRAM2FA_ENABLED', false),

    /**
     * Life time OTP in minutes
     * 0 = eternal
     */
    'lifetime' => env('OTP_TELEGRAM2FA_LIFETIME', 0),

    /**
     * User's table column for secret chat
     */
    'otp_secret_column' => 'id_telegram',

    /**
     * User's table column for comfirmation secret chat
     */
    'otp_secret_confirmed' => 'telegram_confirmed_at',

    /**
     * View for configuration (enable/disable)
     */
    'view' => 'auth.telegram-app.configuracion'
];
